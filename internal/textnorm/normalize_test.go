...
func TestNormalize(t *testing.T) {
	...
	tests := []struct {
		...
		{"explicit paren", "HUMBLE. (Explicit)", "humble"},
		{"clean paren", "HUMBLE. (Clean)", "humble"},
		{"explicit version", "HUMBLE. (Explicit Version)", "humble"},
		...
		{"brackets explicit", "Song [Explicit]", "song"},
